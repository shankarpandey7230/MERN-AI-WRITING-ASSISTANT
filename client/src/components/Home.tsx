    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-20 px-6">
          <div className="max-w-4xl mx-auto md:w-1/2 mb-10 md:mb-0">
            ...
            <Link
              to="/editor"
              className="bg-white text-blue-500 font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-100 transition duration-300"
            >
              Start Writing Now
            </Link>
        
          <div className= "md:w-1/2">
          <img style={{width:"70%", height:"auto"}} src={ai} alt="AI Writing" className="rounded-lg shadow-2xl"/></div>
          </div>
        </section>
        {/* Features Section */}
<section className ="py-20 px-6 bg-gray-100">
  <div className= "container mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-gray-800">Powerful Features at Your Fingertips</h2>
    <div className = "grid grid-cols-1 md:grid-cols-3 gap-12">
     ...
     <footer className="bg-gray-800 text-white py-8 text-center">
      <p>
        AI Writing Assistant @{new Date().getFullYear()} | Powered by Shankar Pandey
      </p>
      </footer> 
